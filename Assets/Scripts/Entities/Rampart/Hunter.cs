...
namespace Assets.Scripts.Entities.Rampart
{
    public class Hunter : Entity
    {
        ...
        public Hunter() : base(Race.RaceType.Elf, EntityClass.Crossbowman, false) //todo need archer class and bows
        {
            var entityPrefabStore = Object.FindObjectOfType<EntityPrefabStore>();

            CombatSpritePrefab = entityPrefabStore.GetCombatSpritePrefab("Hunter");
