...
namespace Assets.Scripts.Abilities
{
    ...
    public class VampireBite : Ability, ISubscriber
    {
        ...
        public VampireBite(Entity abilityOwner) : base("Vampire Bite", "Vampire gains life equal to damage dealt to target.", 6, 1, abilityOwner, TargetType.Hostile, false, false)
        {
        }
