...
namespace ES3Types
{
	...
	public class ES3UserType_ClawAttack : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_ClawAttack() : base(typeof(Assets.Scripts.Abilities.ClawAttack)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.ClawAttack)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.ClawAttack(null);
	...
	public class ES3UserType_ClawAttackArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_ClawAttackArray() : base(typeof(Assets.Scripts.Abilities.ClawAttack[]), ES3UserType_ClawAttack.Instance)
		{
			Instance = this;
		}
	}
