...
namespace ES3Types
{
	...
	public class ES3UserType_GuidedStrikes : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_GuidedStrikes() : base(typeof(Assets.Scripts.Abilities.GuidedStrikes)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.GuidedStrikes)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.GuidedStrikes(null);
	...
	public class ES3UserType_GuidedStrikesArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_GuidedStrikesArray() : base(typeof(Assets.Scripts.Abilities.GuidedStrikes[]), ES3UserType_GuidedStrikes.Instance)
		{
			Instance = this;
		}
	}
