...
namespace ES3Types
{
	...
	public class ES3UserType_Knockback : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Knockback() : base(typeof(Assets.Scripts.Abilities.Knockback)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.Knockback)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.Knockback(null);
	...
	public class ES3UserType_KnockbackArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_KnockbackArray() : base(typeof(Assets.Scripts.Abilities.Knockback[]), ES3UserType_Knockback.Instance)
		{
			Instance = this;
		}
	}
