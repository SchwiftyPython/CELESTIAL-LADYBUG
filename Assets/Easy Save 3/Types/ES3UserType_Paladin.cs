...
namespace ES3Types
{
	...
	public class ES3UserType_Paladin : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Paladin() : base(typeof(Assets.Scripts.Entities.Companions.Paladin)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Entities.Companions.Paladin)obj;
		...
		{
			var instance = new Assets.Scripts.Entities.Companions.Paladin(Race.RaceType.Human, true);
	...
	public class ES3UserType_PaladinArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_PaladinArray() : base(typeof(Assets.Scripts.Entities.Companions.Paladin[]), ES3UserType_Paladin.Instance)
		{
			Instance = this;
		}
	}
