...
namespace ES3Types
{
	...
	public class ES3UserType_Gladiator : ES3ObjectType
	{
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					reader.SetPrivateField("<Abilities>k__BackingField", reader.Read<System.Collections.Generic.Dictionary<System.String, Assets.Scripts.Abilities.Ability>>(), instance);
					break;
		...
		{
			var instance = new Assets.Scripts.Entities.Companions.Gladiator(Race.RaceType.Human, true);
	...
	public class ES3UserType_GladiatorArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_GladiatorArray() : base(typeof(Assets.Scripts.Entities.Companions.Gladiator[]), ES3UserType_Gladiator.Instance)
		{
			Instance = this;
		}
	}
