...
namespace ES3Types
{
	...
	public class ES3UserType_AimedShot : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_AimedShot() : base(typeof(Assets.Scripts.Abilities.AimedShot)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.AimedShot)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.AimedShot(null);
	...
	public class ES3UserType_AimedShotArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_AimedShotArray() : base(typeof(Assets.Scripts.Abilities.AimedShot[]), ES3UserType_AimedShot.Instance)
		{
			Instance = this;
		}
	}
