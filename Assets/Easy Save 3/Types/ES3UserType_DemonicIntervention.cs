...
namespace ES3Types
{
	...
	public class ES3UserType_DemonicIntervention : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_DemonicIntervention() : base(typeof(Assets.Scripts.Abilities.DemonicIntervention)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.DemonicIntervention)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.DemonicIntervention(null);
	...
	public class ES3UserType_DemonicInterventionArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_DemonicInterventionArray() : base(typeof(Assets.Scripts.Abilities.DemonicIntervention[]), ES3UserType_DemonicIntervention.Instance)
		{
			Instance = this;
		}
	}
