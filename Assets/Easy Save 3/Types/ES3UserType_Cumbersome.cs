...
namespace ES3Types
{
	...
	public class ES3UserType_Cumbersome : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Cumbersome() : base(typeof(Assets.Scripts.Abilities.Cumbersome)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.Cumbersome)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.Cumbersome(null);
	...
	public class ES3UserType_CumbersomeArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_CumbersomeArray() : base(typeof(Assets.Scripts.Abilities.Cumbersome[]), ES3UserType_Cumbersome.Instance)
		{
			Instance = this;
		}
	}
