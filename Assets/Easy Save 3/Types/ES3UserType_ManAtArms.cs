...
namespace ES3Types
{
	...
	public class ES3UserType_ManAtArms : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_ManAtArms() : base(typeof(Assets.Scripts.Entities.Companions.ManAtArms)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Entities.Companions.ManAtArms)obj;
		...
		{
			var instance = new Assets.Scripts.Entities.Companions.ManAtArms(Race.RaceType.Human, true);
	...
	public class ES3UserType_ManAtArmsArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_ManAtArmsArray() : base(typeof(Assets.Scripts.Entities.Companions.ManAtArms[]), ES3UserType_ManAtArms.Instance)
		{
			Instance = this;
		}
	}
