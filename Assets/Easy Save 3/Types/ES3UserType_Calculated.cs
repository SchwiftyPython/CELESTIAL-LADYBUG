...
namespace ES3Types
{
	...
	public class ES3UserType_Calculated : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Calculated() : base(typeof(Assets.Scripts.Abilities.Calculated)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.Calculated)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.Calculated(null);
	...
	public class ES3UserType_CalculatedArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_CalculatedArray() : base(typeof(Assets.Scripts.Abilities.Calculated[]), ES3UserType_Calculated.Instance)
		{
			Instance = this;
		}
	}
