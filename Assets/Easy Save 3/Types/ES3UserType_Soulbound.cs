...
namespace ES3Types
{
	...
	public class ES3UserType_Soulbound : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Soulbound() : base(typeof(Assets.Scripts.Abilities.Soulbound)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.Soulbound)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.Soulbound(null);
	...
	public class ES3UserType_SoulboundArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_SoulboundArray() : base(typeof(Assets.Scripts.Abilities.Soulbound[]), ES3UserType_Soulbound.Instance)
		{
			Instance = this;
		}
	}
