...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("_savedFromDeath", "<Name>k__BackingField", "<Description>k__BackingField", "<ApCost>k__BackingField", "<Range>k__BackingField", "<AbilityOwner>k__BackingField", "<TargetType>k__BackingField", "<IsPassive>k__BackingField", "<Icon>k__BackingField", "<UsesEquipment>k__BackingField")]
	public class ES3UserType_EndangeredEndurance : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_EndangeredEndurance() : base(typeof(Assets.Scripts.Abilities.EndangeredEndurance)){ Instance = this; priority = 1; }
		...
		protected override void WriteObject(object obj, ES3Writer writer)
		{
			...
			writer.WritePrivateField("_savedFromDeath", instance);
		...
		{
			var instance = new Assets.Scripts.Abilities.EndangeredEndurance(null);
	...
	public class ES3UserType_EndangeredEnduranceArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_EndangeredEnduranceArray() : base(typeof(Assets.Scripts.Abilities.EndangeredEndurance[]), ES3UserType_EndangeredEndurance.Instance)
		{
			Instance = this;
		}
	}
