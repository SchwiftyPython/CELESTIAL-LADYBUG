...
namespace ES3Types
{
	...
	public class ES3UserType_Crossbowman : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Crossbowman() : base(typeof(Assets.Scripts.Entities.Companions.Crossbowman)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Entities.Companions.Crossbowman)obj;
		...
		{
			var instance = new Assets.Scripts.Entities.Companions.Crossbowman(Race.RaceType.Human, true);
	...
	public class ES3UserType_CrossbowmanArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_CrossbowmanArray() : base(typeof(Assets.Scripts.Entities.Companions.Crossbowman[]), ES3UserType_Crossbowman.Instance)
		{
			Instance = this;
		}
	}
