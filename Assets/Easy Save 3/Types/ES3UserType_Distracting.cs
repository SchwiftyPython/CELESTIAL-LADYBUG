...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("_blindedTiles", "<Name>k__BackingField", "<Description>k__BackingField", "<ApCost>k__BackingField", "<Range>k__BackingField", "<TargetType>k__BackingField", "<IsPassive>k__BackingField", "<Icon>k__BackingField", "<UsesEquipment>k__BackingField")]
	public class ES3UserType_Distracting : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Distracting() : base(typeof(Assets.Scripts.Abilities.Distracting)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.Distracting)obj;
			
			writer.WritePrivateField("_blindedTiles", instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "_blindedTiles":
					reader.SetPrivateField("_blindedTiles", reader.Read<System.Collections.Generic.List<Assets.Scripts.Combat.Tile>>(), instance);
					break;
		...
		{
			var instance = new Assets.Scripts.Abilities.Distracting(null);
	...
	public class ES3UserType_DistractingArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_DistractingArray() : base(typeof(Assets.Scripts.Abilities.Distracting[]), ES3UserType_Distracting.Instance)
		{
			Instance = this;
		}
	}
