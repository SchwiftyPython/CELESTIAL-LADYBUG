...
namespace ES3Types
{
	...
	public class ES3UserType_Spearman : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Spearman() : base(typeof(Assets.Scripts.Entities.Companions.Spearman)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Entities.Companions.Spearman)obj;
		...
		{
			var instance = new Assets.Scripts.Entities.Companions.Spearman(Race.RaceType.Human, true);
	...
	public class ES3UserType_SpearmanArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_SpearmanArray() : base(typeof(Assets.Scripts.Entities.Companions.Spearman[]), ES3UserType_Spearman.Instance)
		{
			Instance = this;
		}
	}
