...
namespace ES3Types
{
	...
	public class ES3UserType_Nimble : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_Nimble() : base(typeof(Assets.Scripts.Effects.Nimble)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Effects.Nimble)obj;
		...
		{
			var instance = new Assets.Scripts.Effects.Nimble();
	...
	public class ES3UserType_NimbleArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_NimbleArray() : base(typeof(Assets.Scripts.Effects.Nimble[]), ES3UserType_Nimble.Instance)
		{
			Instance = this;
		}
	}
