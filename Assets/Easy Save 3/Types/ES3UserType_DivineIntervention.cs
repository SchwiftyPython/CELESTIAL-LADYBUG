...
namespace ES3Types
{
	...
	public class ES3UserType_DivineIntervention : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_DivineIntervention() : base(typeof(Assets.Scripts.Abilities.DivineIntervention)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.DivineIntervention)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.DivineIntervention(null);
	...
	public class ES3UserType_DivineInterventionArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_DivineInterventionArray() : base(typeof(Assets.Scripts.Abilities.DivineIntervention[]), ES3UserType_DivineIntervention.Instance)
		{
			Instance = this;
		}
	}
