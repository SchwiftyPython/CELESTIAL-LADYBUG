...
namespace ES3Types
{
	...
	public class ES3UserType_Entity : ES3ObjectType
	{
		...
		public ES3UserType_Entity() : base(typeof(Assets.Scripts.Entities.Entity)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Entities.Entity)obj;
		...
		{
			var instance = new Entity(Race.RaceType.Human, EntityClass.ManAtArms, false);
	...
	public class ES3UserType_EntityArray : ES3ArrayType
	{
		...
		public ES3UserType_EntityArray() : base(typeof(Assets.Scripts.Entities.Entity[]), ES3UserType_Entity.Instance)
		{
			Instance = this;
		}
	}
