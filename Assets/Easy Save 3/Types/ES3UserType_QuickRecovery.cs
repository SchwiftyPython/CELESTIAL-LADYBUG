...
namespace ES3Types
{
	...
	public class ES3UserType_QuickRecovery : ES3ObjectType
	{
		...
		public ES3UserType_QuickRecovery() : base(typeof(Assets.Scripts.Abilities.QuickRecovery)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (Assets.Scripts.Abilities.QuickRecovery)obj;
		...
		{
			var instance = new Assets.Scripts.Abilities.QuickRecovery(null);
	...
	public class ES3UserType_QuickRecoveryArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_QuickRecoveryArray() : base(typeof(Assets.Scripts.Abilities.QuickRecovery[]), ES3UserType_QuickRecovery.Instance)
		{
			Instance = this;
		}
	}
